...
exports.isAllowed = function (req, res, next) {
  ...
  if (req.client && req.user && req.client.user && req.client.user.providerData && req.user.providerData && req.client.user.providerData.team_id === req.user.providerData.team_id) {
    return next();
  }
