...
exports.isAllowed = function (req, res, next) {
  ...
  if (req.invoice && req.user && req.invoice.user && req.invoice.user.providerData && req.user.providerData && req.invoice.user.providerData.team_id === req.user.providerData.team_id) {
    return next();
  }
