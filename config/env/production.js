...
module.exports = {
  ...
  db: {
    uri: 'mongodb://genrich:!QAZ2wsx@candidate.62.mongolayer.com:10801,candidate.52.mongolayer.com:10916/app49743472',
    options: {
      user: 'genrich',
      pass: '!QAZ2wsx'
    },
  ...
  slack: {
    ...
    scope: 'bot,incoming-webhook,chat:write:bot,chat:write:user'
  },
  apiai: {
